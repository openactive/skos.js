...
function ConceptScheme(a,b){if(Array.isArray(a)){if("undefined"===typeof b)throw Error("ID must be supplied with Concept array");this.scheme={type:"ConceptScheme",id:b,concept:a}}else if("object"===typeof a&&null!==a&&"undefined"!==typeof a.concept&&"undefined"!==typeof a.id&&"ConceptScheme"===a.type)this.scheme=a;else throw Error("Invalid scheme supplied to ConceptScheme");a=[];b={};for(var d={},e=[],c,g=0;g<this.scheme.concept.length;g++){c=new Concept(this.scheme.concept[g]);c._partOfScheme=!0;
d[c.id]=c;b[c.prefLabel]=c;e.push(c);if(c.altLabel&&Array.isArray(c.altLabel))for(var f=0;f<c.altLabel.length;f++)b[c.altLabel[f]]=c;this.scheme.concept[g].topConceptOf===this.scheme.id&&a.push(c)}for(g=0;g<e.length;g++){c=e[g];f={};var k=c._originalConcept.broader||c._originalConcept.broaderTransitive||[];Array.isArray(k)||(k=[k]);for(var h=0;h<k.length;h++){var l=k[h];if(d[l]){if(!0===f[l])throw Error('Invalid scheme supplied to ConceptScheme: Concept "'+c.id+'" has duplicated broader references to "'+
l+'"');c._broaderConcepts.push(d[l]);f[l]=!0}else throw Error('Invalid scheme supplied to ConceptScheme: Concept "'+c.id+'" has referenced broader Concept "'+l+'", which was not found in scheme');}if(c._originalConcept.related&&Array.isArray(c._originalConcept.related))for(f={},k=0;k<c._originalConcept.related.length;k++)if(h=c._originalConcept.related[k],d[h]){if(!0===f[h])throw Error('Invalid scheme supplied to ConceptScheme: Concept "'+c.id+'" has duplicated related references to "'+h+'"');c._relatedConcepts.push(d[h]);
f[h]=!0}else throw Error('Invalid scheme supplied to ConceptScheme: Concept "'+c.id+'" has referenced related Concept "'+h+'", which was not found in scheme');}for(g=0;g<e.length;g++)for(c=e[g],f=0;f<c._broaderConcepts.length;f++)c._broaderConcepts[f]._narrowerConcepts.push(c);this.topConcepts=a.sort(Concept.compare);this.index=d;this.labelIndex=b}ConceptScheme.prototype.getConceptByID=function(a){return this.index[a]?this.index[a]:null};

...
describe('ID prefixes', function () {
  it('getPrefixedID("oa:activity-list#1") == "oa:activity-list#1"', function () {
    expect(skos.Concept.getPrefixedID('oa:activity-list#1')).toEqual('oa:activity-list#1');
  });
  it('getPrefixedID("https://openactive.io/activity-list#1") == "oa:activity-list#1"', function () {
    expect(skos.Concept.getPrefixedID('https://openactive.io/activity-list#1')).toEqual('oa:activity-list#1');
  });
  it('getFullyQualifiedID("oa:activity-list#1") == "https://openactive.io/activity-list#1"', function () {
    expect(skos.Concept.getFullyQualifiedID('oa:activity-list#1')).toEqual('https://openactive.io/activity-list#1');
  });
  it('getFullyQualifiedID("https://openactive.io/activity-list#1") == "https://openactive.io/activity-list#1"', function () {
    expect(skos.Concept.getFullyQualifiedID('https://openactive.io/activity-list#1')).toEqual('https://openactive.io/activity-list#1');
  });
});
